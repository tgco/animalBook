...
public class UpgradesScreen extends ButtonScreenAdapter implements Screen {
	...
	public void drawAmounts(float alpha, int boxName){
		...
		case 1:
			...
			font.draw(batch, "$" + String.valueOf(gameScreen.getWorld().getLongerMoneyP()), STRING_WIDTH_FR, Gdx.graphics.getHeight()/2 - EDGE_TOLERANCE +40);
			break;
		case 2:
			...
			font.draw(batch, "$" + String.valueOf(gameScreen.getWorld().getMoreMoneyP()), STRING_WIDTH_FR, Gdx.graphics.getHeight()/2 - EDGE_TOLERANCE +40);
			break;
		}
